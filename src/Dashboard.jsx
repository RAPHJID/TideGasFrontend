...
function statusBadge(status) {
  const map = { Pending: "badge-amber", Processing: "badge-blue", Completed: "badge-green", Cancelled: "badge-red" };
    ...
    <>
      ...
      <div className="page">
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 22, color: "#c8e6c8", fontWeight: 700, letterSpacing: "0.5px" }}>{userEmail.split("@")[0].toUpperCase()}</div>
        </div>
        ...
        <div className="stat-grid">
          ...
          <div className="stat">
            ...
            <div className="stat-value sm">{todayRevenue.toFixed(0)}</div>
            <div className="stat-sub">QAR</div>
          </div>
        ...
        <div className="card" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ fontSize: 12, color: "#2e5c2e", textTransform: "uppercase", letterSpacing: "1px" }}>All time</div>
