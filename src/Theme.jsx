export const BASE_CSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .section-label { font-size: 10px; color: #2e5c2e; text-transform: uppercase; letter-spacing: 1.5px; margin: 16px 0 10px; }
  .card { background: #0d150d; border: 1px solid #1a2e1a; border-radius: 14px; padding: 14px 16px; margin-bottom: 10px; }
  ...
  .btn { width: 100%; padding: 14px; font-size: 13px; font-weight: 600; border-radius: 12px; border: 1px solid #2e5c2e; cursor: pointer; font-family: inherit; background: #0d150d; color: #4caf50; letter-spacing: 0.5px; text-transform: uppercase; transition: background 0.15s; }
  ...
  .badge { display: inline-block; padding: 3px 10px; border-radius: 6px; font-size: 10px; font-weight: 600; border: 1px solid; letter-spacing: 0.5px; text-transform: uppercase; }
  ...
  .field input, .field select { width: 100%; padding: 13px 14px; font-size: 15px; border: 1px solid #1a2e1a; border-radius: 10px; outline: none; font-family: inherit; color: #c8e6c8; background: #0d150d; transition: border-color 0.15s; }
  ...
  .info-box { background: #0a121a; border: 1px solid #1a3a5c; border-radius: 10px; padding: 12px 14px; font-size: 12px; color: #42a5f5; margin-bottom: 14px; letter-spacing: 0.3px; }
  .list-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #111811; }
  ...
  .modal-bg { position: fixed; inset: 0; background: rgba(0,0,0,0.85); display: flex; align-items: flex-end; justify-content: center; z-index: 300; }
  .modal { background: #0d150d; border: 1px solid #1a2e1a; border-radius: 20px 20px 0 0; padding: 20px 16px 36px; width: 100%; max-width: 480px; max-height: 90vh; overflow-y: auto; }
  .modal-handle { width: 40px; height: 4px; background: #1a2e1a; border-radius: 2px; margin: 0 auto 20px; }
  .modal h2 { font-size: 15px; font-weight: 700; color: #c8e6c8; margin-bottom: 20px; letter-spacing: 1px; text-transform: uppercase; }
  ...
  .stock-bar-wrap { width: 100%; background: #111811; border-radius: 3px; height: 4px; margin-bottom: 12px; }
  .stock-bar { height: 4px; border-radius: 3px; background: #4caf50; }
  .stock-bar.low { background: #ef5350; }
  .stock-bar.mid { background: #f59e0b; }
  .role-tag { display: inline-block; padding: 2px 8px; border-radius: 5px; font-size: 9px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; border: 1px solid; margin-left: 6px; vertical-align: middle; }
  .role-tag.admin { color: #4caf50; border-color: #1a3d1a; background: #0d1a0d; }
  .role-tag.staff { color: #42a5f5; border-color: #1a3a5c; background: #0a121a; }
`;
